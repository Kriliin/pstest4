export const AbilitiesText: {[k: string]: AbilityText} = {
	...
	aftermath: {
		name: "Aftermath",
		desc: "If this Pokeman is knocked out with a contact move, that move's user loses 1/4 of its maximum HP, rounded down. If any active Pokemon has the Damp Ability, this effect is prevented.",
		shortDesc: "If this Pokeman is KOed with a contact move, that move's user loses 1/4 its max HP.",
